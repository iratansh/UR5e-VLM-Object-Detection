...
class TestPhase1SpeechProcessing(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.rasa_nlp = ConstructionRasaNLP()
    ...
    def test_rasa_nlp_intent_recognition(self):
        """Test Rasa NLP intent recognition for construction commands"""
        ...
        for command, expected_intent in test_commands:
            result = self.rasa_nlp.parse_construction_command(command)
            self.assertIsNotNone(result)
            self.assertEqual(result.intent, expected_intent, 
                           f"Command '{command}' should have intent '{expected_intent}', got '{result.intent}'")
    
    def test_rasa_entity_extraction(self):
    ...
    def test_speech_command_processing_with_rasa(self):
        """Test SpeechCommandProcessor integration with Rasa NLP"""
...
class TestIntegrationCompleteness(unittest.TestCase):
    ...
    def test_all_phases_implemented(self):
        ...
        self.assertIsNotNone(self.speech_processor.rasa_nlp)       # Rasa NLP  
